...
message(STATUS "  CMake:      ${CMAKE_VERSION}  (minimum 3.28)")
message(STATUS "  C++:        C++${CMAKE_CXX_STANDARD}")
message(STATUS "  Build type: ${CMAKE_BUILD_TYPE}")
message(STATUS "  Frontend:   ${FRONTEND_DIST}")
message(STATUS "  bun:        ${BUN_EXECUTABLE}")
message(STATUS "  Deps:       FetchContent (tarball URLs, no git clone, no vcpkg hook)")
if(SQLCIPHER_FOUND)
...
message(STATUS "")
message(STATUS "  Tip: FETCHCONTENT_FULLY_DISCONNECTED=ON reuses cached downloads")
message(STATUS "")
