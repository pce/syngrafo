...
image::data/inp/syngrafo_img_2_svg.jpg[Static,300]

Image to SVG with AB as chosen Colorpaltte
- RCT for Pixel Perfect
- PLY for Polygonal and
- TRI for triangulated

conversion with support for ColorPalettes.

[cols="1,1,1",options="header"]
|===
| ORIG | PLY (Polygonal) | TRI (Triangulated)

| image:data/inp/trees.jpg[width=250]
Original raster image

| image:data/inp/trees_ply.svg[width=250]
Polygonal approximation

| image:data/inp/trees_tri.svg[width=250]
Triangulated mesh
|===
