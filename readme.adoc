...
image:https://img.shields.io/badge/platform-macOS%20%7C%20Linux-lightgrey[]
image:https://github.com/pce/tools/actions/workflows/release.yml/badge.svg[CI]
...
----
app/
  main.cc                 — startup, 32 saucer expose() bindings
...
| *Notes* | Markdown-lite `.notes` files in any folder
| *Kanban* | `.kanban` boards with drag-and-drop lanes
...
| Clang / AppleClang | C++23 | Compiler
...
* [ ] FolderOptions serialisation (MessagePack/CBOR) + cross-machine Zone sync
* [ ] Per-file / per-record encryption
* [ ] Audio project view: BPM/key classification, sample manager
* [ ] HTML preview (sandboxed local server)
* [ ] PDF/DOCX document creation and conversion
* [ ] Windows packaging
